  ...
  return (
    <Box aria-label="page" sx={{ flexGrow: 1 }}>
      ...
      <ProjectSpotlight
        ...
        (Discovery Mode) allows users to query the EtherCAT master for network topology, recognizing and displaying robots built from physical modules
        in 3D. The system seamlessly produces URDF, SRDF, and a full ROS package that can then be utilized for simulating and controlling the robot.
      </ProjectSpotlight>
      ...
      <ProjectSpotlight
        ...
        This project focused on automating the calibration of EtherCAT actuators and robotic modules, aiming for a fully automated procedure for newly
        assembled actuators. The process involved testing the PDO, conducting phase angle calibration, torque sensor calibration, ripple and
      ...
      <ProjectSpotlight
        ...
        This thesis proposes a design for a small mobile robot controlled by voice. Firstly a preliminary analysis of the state of art of human-robot
        interaction has been conducted. Then, an analysis of the equipment selected took place, and, later, appropriate methodologies for voice
        recognition and user detection have been evaluated for this specific case. Finally, an overview of the complete software architecture of the
        system was given with three possible structures and their comparison. The results obtained show both the feasibility of using low power boards
